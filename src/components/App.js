...
const AppRoutes = () => {
  ...
  return (
    <Routes>
      <Route
        path="/"
        element={isSubscriptionBuy && isLoggedIn ? <HomeNew /> : <Home />}
      />
      ...
      >
        ...
        <Route
          path="/developments/:id/property"
          element={<DevelopmentPropertyListing />}
        />
        <Route
          path="/developmentpropertydetail"
          element={<DevelopmentPropertyDetail />}
        />
        <Route path="/explore" element={<ExploreProperty />} />
        <Route path="/AddProperty" element={<AddProperty />} />
        <Route
          path="/addpropertydevelopment"
          element={<AddPropertyDevelopment />}
        />
